...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AIANALYZER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AIANALYZER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AIANALYZER actions', async () => {
      const arg = { id: 26238 };
    ...
    it('dispatches UPDATE_AIANALYZER actions', async () => {
      const arg = { id: 26238 };
    ...
    it('dispatches PARTIAL_UPDATE_AIANALYZER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AIANALYZER actions', async () => {
      const arg = 42666;
