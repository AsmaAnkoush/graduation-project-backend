...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HEALTHWORKER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_HEALTHWORKER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_HEALTHWORKER actions', async () => {
      const arg = { id: 24464 };
    ...
    it('dispatches UPDATE_HEALTHWORKER actions', async () => {
      const arg = { id: 24464 };
    ...
    it('dispatches PARTIAL_UPDATE_HEALTHWORKER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_HEALTHWORKER actions', async () => {
      const arg = 42666;
