...
export const ParentUpdate = () => {
  ...
  const handleClose = () => {
    navigate(`/parent${location.search}`);
  };
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="smartVaxApp.parent.home.createOrEditLabel" data-cy="ParentCreateUpdateHeading">
            <Translate contentKey="smartVaxApp.parent.home.createOrEditLabel">Create or edit a Parent</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('smartVaxApp.parent.name')}
                id="parent-name"
                name="name"
                data-cy="name"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('smartVaxApp.parent.phone')}
                id="parent-phone"
                name="phone"
                data-cy="phone"
                type="text"
              ...
              />
              <ValidatedField label={translate('smartVaxApp.parent.dob')} id="parent-dob" name="dob" data-cy="dob" type="date" />
              <ValidatedField
                label={translate('smartVaxApp.parent.role')}
                id="parent-role"
                name="role"
                data-cy="role"
                type="text"
