...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VACCINATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VACCINATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VACCINATION actions', async () => {
      const arg = { id: 15083 };
    ...
    it('dispatches UPDATE_VACCINATION actions', async () => {
      const arg = { id: 15083 };
    ...
    it('dispatches PARTIAL_UPDATE_VACCINATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VACCINATION actions', async () => {
      const arg = 42666;
