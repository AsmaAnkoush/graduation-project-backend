...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HEALTHRECORD_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_HEALTHRECORD actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_HEALTHRECORD actions', async () => {
      const arg = { id: 20174 };
    ...
    it('dispatches UPDATE_HEALTHRECORD actions', async () => {
      const arg = { id: 20174 };
    ...
    it('dispatches PARTIAL_UPDATE_HEALTHRECORD actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_HEALTHRECORD actions', async () => {
      const arg = 42666;
