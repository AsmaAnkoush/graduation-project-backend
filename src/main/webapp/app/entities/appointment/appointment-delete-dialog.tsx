...
import { deleteEntity, getEntity } from './appointment.reducer';
...
export const AppointmentDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/appointment${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="smartVaxApp.appointment.delete.question">
        <Translate contentKey="smartVaxApp.appointment.delete.question" interpolate={{ id: appointmentEntity.id }}>
