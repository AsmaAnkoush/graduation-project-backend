...
import reducer, {
  ...
  reset,
  updateEntity,
} from './schedule-vaccination.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SCHEDULEVACCINATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SCHEDULEVACCINATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SCHEDULEVACCINATION actions', async () => {
      const arg = { id: 8251 };
    ...
    it('dispatches UPDATE_SCHEDULEVACCINATION actions', async () => {
      const arg = { id: 8251 };
    ...
    it('dispatches PARTIAL_UPDATE_SCHEDULEVACCINATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SCHEDULEVACCINATION actions', async () => {
      const arg = 42666;
