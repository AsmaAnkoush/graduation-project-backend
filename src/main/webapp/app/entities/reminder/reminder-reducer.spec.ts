...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './reminder.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REMINDER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_REMINDER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_REMINDER actions', async () => {
      const arg = { id: 4478 };
    ...
    it('dispatches UPDATE_REMINDER actions', async () => {
      const arg = { id: 4478 };
    ...
    it('dispatches PARTIAL_UPDATE_REMINDER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_REMINDER actions', async () => {
      const arg = 42666;
