...
public class OpenAIService {
    ...
    private static final String API_KEY = "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"; // 🔥 ضع مفتاح OpenAI هنا

    public String getSuggestions(String symptoms) {
        // نص البرومبت (السؤال الموجه للذكاء الاصطناعي)
        String prompt = "أنا طبيب أطفال. ظهرت الأعراض التالية على الطفل بعد التطعيم: " + symptoms +
            ". ماذا يجب أن أنصح به الأهل؟ قدم نصيحة طبية عملية وواضحة.";

        // إعداد Body للطلب
        Map<String, Object> body = Map.of(
            "model", "gpt-3.5-turbo", // يمكنك استخدام gpt-4 لو متاح بحسابك
            "messages", List.of(
                Map.of(
                    "role", "user",
                    "content", prompt
            ...
            "temperature", 0.7 // (تحكم في تنوع الإجابات)
        );
